...
<body>
	<div style="width: 700px; margin-left: auto; margin-right: auto;">
		로그인: ${employee.name} <input type="button" value="로그아웃" onclick="location.href='?logout=yes'">
	</div>	
	<div style="width: 700px; margin-left: auto; margin-right: auto; margin-top: 20px; border: solid 1px;">
		...
		<section>
			<nav>
				<div style="height: 30px;">업무 알림</div>
			...
			<article>
				<div style="height: 30px;">
					<span>재원환자조회</span> 
					<input type="button" name="patient" value="신환접수" style="float: right;" onclick="location.href='insertPatient.jsp'"></input>
				</div>
